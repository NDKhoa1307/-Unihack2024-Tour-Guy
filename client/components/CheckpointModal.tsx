                            ...
                            <View style={styles.reviewContainer}>
                                ...
                                <View style={styles.reviewProfile}>
                                    <TruncateText numberOfLines={3}>
                                        ...
                                        Sunny Beach! The golden sand was clean and soft, perfect for lounging around and
                                        building sandcastles. The water was crystal clear and refreshing, just the right
                                        ...
                                        highlight of my trip. Highly recommend for anyone looking for a relaxing beach
                                        day!
                                    </TruncateText>
                                    <Text style={styles.reviewProfileName}>User 1</Text>
                                    <View style={styles.reviewProfileRating}>
                            ...
                            <View style={styles.reviewContainer}>
                                ...
                                <View style={styles.reviewProfile}>
                                    <TruncateText numberOfLines={3}>Visited Oceanview Beach with my family
                                        last weekend, and it was a great experience. The beach was well-maintained, and
                                        ...
                                        explored the nearby coves. The only downside was that it got quite crowded in
